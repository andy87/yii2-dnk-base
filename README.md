...
Текущий основной способ установки для этого репозитория — GitHub VCS. Пакет `andy87/yii2-dnk-base` не найден в публичном Packagist на 2026-04-28:

```bash
composer config repositories.yii2-dnk-base vcs https://github.com/andy87/yii2-dnk-base
...
- **SKILL.md** — canonical source правил DNK flow, ответственности слоёв, антипаттернов и scaffold-шаблонов.
- **reference.md** — краткий справочник, ссылается на SKILL.md.
- **CHECKLIST.md** — чеклист проверок при работе с DNK.
